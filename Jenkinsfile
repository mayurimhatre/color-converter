        ...
        stage('Test'){
            steps {
                wrap([$class: 'HailstoneBuildWrapper', location: env.IASTAGENT_REMOTE_ENDPOINT_HTTP_LOCATION, port: env.IASTAGENT_REMOTE_ENDPOINT_HTTP_PORT]) {
                    ...
                    sh "forever start -l ${BUILD_TAG}.log -o ${BUILD_TAG}-out.log -e ${BUILD_TAG}-err.log --killSignal SIGTERM --minUptime 1000 --spinSleepTime 1000 -c 'IASTAGENT_REMOTE_ENDPOINT_HTTP_ENABLED=true node -r ./agent_nodejs_linux64' app/server.js"
